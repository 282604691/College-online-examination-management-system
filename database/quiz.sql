...
CREATE TABLE `claacc` (
  ...
  `cla_id` int(20) DEFAULT NULL,
  `tosc_per` int(20) DEFAULT NULL,
  `acsc_per` int(20) DEFAULT NULL,
...
CREATE TABLE `classe` (
  ...
  `classe_name` varchar(255) DEFAULT NULL COMMENT '班级名',
  `teacher_id` int(20) DEFAULT NULL COMMENT '对应教师',
  PRIMARY KEY (`classe_id`) USING BTREE,
  KEY `classe_id` (`classe_id`,`classe_name`) USING BTREE,
  KEY `teacher_id` (`teacher_id`) USING BTREE,
  CONSTRAINT `classe_ibfk_1` FOREIGN KEY (`teacher_id`) REFERENCES `teacher` (`teacher_id`)
...
CREATE TABLE `exam` (
  ...
  `paper_id` int(11) DEFAULT NULL COMMENT '对应试卷',
  `exam_begin` datetime DEFAULT NULL COMMENT '开始时间',
  `exam_end` datetime DEFAULT NULL COMMENT ' 结束时间',
...
INSERT INTO `exam` VALUES (28, 11, '2022-03-26 13:26:00', '2022-03-26 15:27:00');
INSERT INTO `exam` VALUES (29, 11, '2022-03-27 16:31:00', '2022-03-27 17:32:00');
INSERT INTO `exam` VALUES (31, 11, '2022-05-04 11:07:00', '2022-05-04 13:08:00');
COMMIT;
...
CREATE TABLE `paper` (
  ...
  `paper_name` varchar(255) DEFAULT NULL COMMENT '试卷名字',
  `score_sin` int(20) DEFAULT NULL COMMENT '单选分数',
  `score_che` int(20) DEFAULT NULL COMMENT '多选分数',
  `score_jug` int(20) DEFAULT NULL COMMENT '判断分数',
...
CREATE TABLE `question` (
  ...
  `question_type` varchar(255) DEFAULT NULL COMMENT '题目类型x单选，y多选，z判断',
  `question_course` varchar(255) DEFAULT NULL COMMENT '是什么课程的问题python，java,c等',
  `question_name` varchar(255) DEFAULT NULL COMMENT '题目问题',
  `question_opa` varchar(255) DEFAULT NULL COMMENT '选项A',
  `question_opb` varchar(255) DEFAULT NULL COMMENT '选项B',
  `question_opc` varchar(255) DEFAULT NULL COMMENT '选项C',
  `question_opd` varchar(255) DEFAULT NULL COMMENT '选项D',
  `question_opright` varchar(255) DEFAULT NULL COMMENT '正确选项',
...
CREATE TABLE `question_paper` (
  ...
  `question_id` int(20) DEFAULT NULL COMMENT '试题编号',
  `paper_id` int(20) DEFAULT NULL COMMENT '试卷编号',
...
CREATE TABLE `record` (
  ...
  `record_name` varchar(255) DEFAULT NULL COMMENT '考试名称',
  `student_id` int(20) DEFAULT NULL COMMENT '学生id',
  `paper_id` int(20) DEFAULT NULL COMMENT '试卷id',
  `record_answer` varchar(255) DEFAULT NULL COMMENT '答题记录',
  `record_acc` double(255,2) DEFAULT NULL COMMENT '正确率',
  `record_score` int(20) DEFAULT NULL COMMENT '得分',
...
CREATE TABLE `student` (
  ...
  `student_account` varchar(255) NOT NULL COMMENT '账号英文数字组成，可以理解为学号',
  `student_gender` int(20) DEFAULT NULL COMMENT '性别',
  `student_email` varchar(255) DEFAULT NULL COMMENT '邮箱',
  `student_pwd` varchar(255) DEFAULT NULL COMMENT '密码',
...
CREATE TABLE `teacher` (
  ...
  `teacher_account` varchar(255) DEFAULT NULL COMMENT '老师登录账号',
  `teacher_email` varchar(255) DEFAULT NULL COMMENT '邮箱',
  `teacher_pwd` varchar(255) DEFAULT NULL COMMENT '密码',
  `power` int(1) unsigned zerofill DEFAULT '0' COMMENT '拥有后台更改权力',
...
-- ----------------------------
BEGIN;
INSERT INTO `teacher` VALUES (1, '周杰', 'admin', 'zhaosi@qq.com', '123456', 1);
...
CREATE TABLE `toscore` (
  ...
  `paper_id` int(20) DEFAULT NULL COMMENT '试卷id',
  `toscore` int(20) DEFAULT NULL COMMENT '总分',
